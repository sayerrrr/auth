...
export const FileEncryptionKeyLength =
  AesKeyLength + IVBytesLength + HmacKeyLength
...
export const generateFileEncryptionKey = (): string => {
  const encryptionKeyBytes: Uint8Array = crypto.randomBytes(
...
const isBytes = (obj: Buffer | ArrayBuffer): boolean =>
  Buffer.isBuffer(obj) || ArrayBuffer.isView(obj) || obj instanceof ArrayBuffer
